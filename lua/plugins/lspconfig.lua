	...
	config = function()
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("<space>sd", builtin.lsp_document_symbols, "[D]ocument [S]ymbols")
				map("<space>sw", builtin.lsp_dynamic_workspace_symbols, "[W]orkspace [S]ymbols")
				map("<F2>", vim.lsp.buf.rename, "Rename variable")
				map("<F3>", vim.lsp.buf.format, "Autoformat using LSP")
				map("<Leader><F3>", conform.format, "Autoformat using Conform")
